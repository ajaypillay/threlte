...
Command: npx @threlte/gltf@1.0.0-next.2 ./ramp.glb -i -P -t -s -T
-->
<script
  context="module"
  lang="ts"
>
  ...
  const load = () => {
    return useGltf<GLTFResult>('/assets/basic-vehicle-controller/ramp-transformed.glb', {
      useDraco: true
    })
  }

  export const preloadRamp = async () => {
    await load()
  }
</script>
